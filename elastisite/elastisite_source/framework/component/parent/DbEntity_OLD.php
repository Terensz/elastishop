...
abstract class DbEntity extends Kernel
{
    ...
    public function getEntityAttributes($getRelations = true)
    {
        // dump($alma);
        if (!$this->isActive()) {
            // dump($this);
    ...
    */
    public function assemblePropertyMap()
    {
        ...
        foreach ($propertyNames as $propertyName) {
            ...
            if (in_array($propertyName, ['createdBy', 'createdAt'])) {
                $debug2 = true;
            } else {
                $debug2 = false;
            }
            ...
            // if ($debug && $debug2) {
            //     dump('$propertyName: '.$propertyName);
            // }
            ...
            // if ($debug && $propertyName == 'createdBy') {
            //     dump($propertyReflections);
            // }
            // if ($debug) {
            //     dump($propertyName);
            // }
            ...
            */
            ...
            //     dump("============================");
            //     // dump("==************************==");
            //     dump('** propertyParams: ** (Ez jon a masik metodusbol) ');
            //     dump($propertyParams);
            // }
                ...
                if ($propertyReflection['class']) {
                    ...
                    */
                    if ($propertyReflection['class'] || ($propertyParams['setter'] == $propertyParams['setterPre'].$targetClassName)) {
                        ...
                        // if ($debug && $propertyName == 'createdBy') {
                        //     dump($propertyParams['setterPre'].$targetClassName);
                        // }
                    }
                }
