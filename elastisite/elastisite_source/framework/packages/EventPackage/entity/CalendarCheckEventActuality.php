...
class CalendarCheckEventActuality extends DbEntity
{
    const CREATE_TABLE_STATEMENT = "CREATE TABLE `calendar_check_event_actuality` (
        `id` int(11) NOT NULL AUTO_INCREMENT,
        `calendar_check_id` int(11) DEFAULT NULL,
        `calendar_event_actuality_id` int(11) DEFAULT NULL,
        PRIMARY KEY (`id`)
    ...
    protected $calendarEventActuality;
    ...
    public function setCalendarEventActuality(CalendarEventActuality $calendarEventActuality)
    {
        $this->calendarEventActuality = $calendarEventActuality;
    }

	public function getCalendarEventActuality()
	{
		return $this->calendarEventActuality;
	}
}