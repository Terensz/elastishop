    ...
    <div class="col-xs-12 col-sm-{{ inputRate }} col-md-{{ inputRate }} col-lg-{{ inputRate }}">
        <div class="form-group">
            <div class="input-group">
                <textarea disabled name="{{ requestKey }}" id="{{ requestKey }}" class="textarea-input inputField form-control"
                    aria-describedby="" placeholder="{{ placeholder }}">{{ displayedValue }}</textarea>
            </div>
