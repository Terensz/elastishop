<div class="mb-3">
    ...
    <div class="input-group has-validation">
        ...
        <select class="selectpicker form-select inputField{{ isInvalidString }}" data-live-search="true" name="{{ requestKey }}" id="{{ requestKey }}" aria-describedby="{{ requestKey }}-validationMessage" required>
<?php
