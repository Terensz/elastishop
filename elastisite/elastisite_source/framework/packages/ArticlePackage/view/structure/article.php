        ...
        <div id="sheetContainer" class="sheetWidth">
            ...
            <div class="row sheetLevel">
                <div class="col-xl-3 col-lg-4 col-md-4 col-sm-12 widgetRail widgetRail-first">
                    <div class="widgetWrapper-off">
                        <div class="widgetContainer" id="widgetContainer-CalendarWidget">{{ CalendarWidget }}</div>
                    </div>
                ...
                <div class="col-xl-9 col-lg-8 col-md-8 col-sm-12 widgetRail widgetRail-last">
                    <div class="widgetWrapper-off">
                        <div class="widgetContainer" id="widgetContainer-ArticleWidget">{{ ArticleWidget }}</div>
                    </div>
                    <div class="widgetWrapper-off">
                        <div class="widgetContainer" id="widgetContainer-ArticleSearchWidget">{{ ArticleSearchWidget }}</div>
                    </div>
                </div>
            </div>
            <div class="row sheetLevel">
