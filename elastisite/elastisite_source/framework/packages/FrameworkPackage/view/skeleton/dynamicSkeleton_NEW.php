...
<div id="toast" class="toast" role="status" aria-live="off" aria-atomic="true" style="position: fixed; top: 0px; left: 0px; z-index: 3000000000;">
	...
	<div class="toast-body" id="toast-body" style="font-size: 16px !important;"></div>
</div>
<!-- /EditorModal -->
<style>
	/* #videoBox {
...
// var Favicon = {
// 	show: function() {
// 		console.log('<?php echo $httpDomain; ?>/accessory/favicon');
// 		$('#favicon').attr('href', '<?php echo $httpDomain; ?>/accessory/favicon/' + Math.random());
// 	},
// 	reload: function() {
// 		Favicon.show();
