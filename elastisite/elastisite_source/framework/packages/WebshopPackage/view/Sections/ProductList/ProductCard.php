    ...
    <div class="card<?php if ($cartItemData) { echo ' card-highlighted'; } ?>"<?php if (isset($maxWidthPixels)) { echo ' style="max-width: '.$maxWidthPixels.'px;"'; } ?>>
        ...
        <div class="card-footer p-2">
            <div class="d-flex">
                ...
                <a href="<?php echo $productInfoLink = '/'.$localizedProductInfoLinkBase.$productData['id']; ?>" onclick="Webshop.showProductDetailsModalInit(event, '<?php echo $productData['id']; ?>');" class="pc-link" style="display: flex; gap: 0px; text-decoration: none; padding-left: 8px;">
                    <span class="">
