...
class VatDeclarationHelper extends Service
{
    ...
    // public function createReporter($APIUrl, $APIUserData, $APISoftwareData)
    // {
    //     // $config = $this->vatProfileHandler::getConfig($this->vatProfileHandler->taxOfficeName);
    //     $navOnlineConfig = new NavOnlineConfig($APIUrl, $APIUserData, $APISoftwareData);
    ...
    {
        // dump($operation);
        // dump($invoiceXml);exit;
        return $this->reporter->manageInvoice($invoiceXml, $operation);
