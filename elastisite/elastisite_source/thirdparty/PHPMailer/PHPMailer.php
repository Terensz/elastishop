...
class PHPMailer
{
            ...
            if (!empty($this->DKIM_domain)
                ...
                && (!empty($this->DKIM_private_string)
                    || (!empty($this->DKIM_private)
                        ...
                        && framework\kernel\utility\FileHandler::fileExists($this->DKIM_private)
                    )
                )
            ) {
    ...
    public function setLanguage($langcode = 'en', $lang_path = '')
    {
        ...
        if ('en' !== $langcode) {
            ...
            if (!static::isPermittedPath($lang_file) || framework\kernel\utility\FileHandler::fileExists($lang_file)) {
                $foundlang = false;
            } else {
...
//            $result .= static::$LE;
    ...
    {
        try {
            if (!static::isPermittedPath($path) || !framework\kernel\utility\FileHandler::fileExists($path)) {
