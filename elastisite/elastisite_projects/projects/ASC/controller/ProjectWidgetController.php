...
class ProjectWidgetController extends WidgetController
{
    ...
    /**
    * Route: [name: widget_ProjectSplashWidget, paramChain: /widget/ProjectSplashWidget]
    */
    public function projectSplashWidgetAction()
    {
        $viewPath = 'framework/packages/ElastiSitePackage/view/widget/ProjectSplashWidget/widget.php';

        $response = [
            'view' => $this->renderWidget('ProjectSplashWidget', $viewPath, [
                // 'container' => $this->getContainer(),
                'documentTitle' => '',
                'message' => ''
            ]),
