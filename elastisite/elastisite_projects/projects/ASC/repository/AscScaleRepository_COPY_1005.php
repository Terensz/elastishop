...
class AscScaleRepository extends DbRepository 
{
    ...
    public function getScaleAndUnitAccessibility(int $ascScaleId, int $projectUserId = null, $ascUnitId = null) : array
    {
        ...
        foreach ($foundRecords as $foundRecordRow) {
            ...
            */
            ...
            if ($foundRecordRow['asc_unit_id']) {
                $sharedUnitIds[] = $foundRecordRow['asc_unit_id'];
            }
        ...
        */
        ...
        if ($partiallyAccessible && !$fullyAccessible) {
            $accessibleUnits = self::getAccessibleUnits($ascScaleId, $projectUserId, $sharedUnitIds);
            $unitPermissionOverrides = self::getUnitPermissionOverrides($accessibleUnits, $projectUserId);
        }
    ...
    */
    public function getAccessibleUnits(int $ascScaleId, int $projectUserId = null, array $sharedUnitIds = []) : array
    {
        ...
        $params = [];
        $accessibleUnits = $sharedUnitIds;
        
        function collectChildUnits($dbm, $ascScaleId, &$accessibleUnits, &$params, $sharedUnitIds) {
            ...
            foreach ($childUnits as $childUnit) {
                if (!in_array($childUnit['asc_unit_id'], $accessibleUnits)) {
        ...
        collectChildUnits($dbm, $ascScaleId, $accessibleUnits, $params, $sharedUnitIds);
