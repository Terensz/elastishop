...
$menuItemRoutes = [
    ...
    // ],
    [
        'routeName' => 'asc_dashboard',
        'routePath' => 'asc/dashboard',
        'title' => 'admin.scales',
...
.banner-and-navbar {
    ...
    align-items: center;
    background-color: #fff; /* Hozzáadott háttérszín a banner-hez */
}
...
<div class="banner-and-navbar" style="box-shadow: rgba(60, 64, 67, 0.3) 0px 1px 2px 0px, rgba(60, 64, 67, 0.15) 0px 1px 3px 1px;">
