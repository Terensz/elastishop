...
<p>
Ez a dokumentum (továbbiakban: ÁSZF) minden szoftverfejlesztési szerződés része, ami létrejön <b><?php echo $container->getCompanyData('name'); ?></b> és a tőle szoftverfejlesztést megrendelő magánszemély vagy szervezet között.
