                                    ...
                                    <div class="col-12 col-md-6 col-lg-3">
                                        <div class="card-statCircle-container">
                                            ...
                                            <svg class="card-statCircle" width="140" height="140">
                                                ...
                                                <text x="50%" y="50%" text-anchor="middle" dy=".3em" font-size="24"><?php echo $sum['todays']; ?></text>
                                            </svg>
                                        </div>
                                    </div>
                                    <div class="col-12 col-md-6 col-lg-3">
                                        <div class="card-statCircle-container">
                                            ...
                                            <svg class="card-statCircle" width="140" height="140">
                                                ...
                                                <text x="50%" y="50%" text-anchor="middle" dy=".3em" font-size="24"><?php echo $sum['expired']; ?></text>
                                            </svg>
                                        </div>
                                    </div>
                                    <div class="col-12 col-md-6 col-lg-3">
                                        <div class="card-statCircle-container">
                                            ...
                                            <svg class="card-statCircle" width="140" height="140">
                                                ...
                                                <text x="50%" y="50%" text-anchor="middle" dy=".3em" font-size="24"><?php echo $sum['closed']; ?></text>
                                            </svg>
                                        </div>
                                    </div>
                                    <div class="col-12 col-md-6 col-lg-3">
                                        <div class="card-statCircle-container">
                                            ...
                                            <svg class="card-statCircle" width="140" height="140">
                                                ...
                                                <text x="50%" y="50%" text-anchor="middle" dy=".3em" font-size="24"><?php echo $sum['postponed']; ?></text>
                                            </svg>
                                        </div>
                                    </div>
                                </div>
