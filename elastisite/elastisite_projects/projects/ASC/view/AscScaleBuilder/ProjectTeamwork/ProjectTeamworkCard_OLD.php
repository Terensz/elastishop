...
<div class="card">
    <div class="bg-primary text-white card-header d-flex justify-content-between align-items-center">
        <div class="card-header-textContainer">
            <h6 class="mb-0 text-white"><?php echo trans('project.teams'); ?></h6>
            <?php 
    ...
    <div class="mb-3">
        <button type="button" onclick="AscScaleBuilder.inviteUserModal();" class="btn btn-success">Új csapat hozzáadása</button>
    </div>
    ...
    <div class="d-flex align-items-center" style="line-height: 0;">
        ...
        <div class="flex-grow-1" style="height: 100%;">
            <div style="display: flex; align-items: center; height: 40px;">
                <h5 class="m-0">Főcélok</h5>
            </div>
        </div>
    </div>

    <?php if ($scalePermissions['invite']): ?>
    <div class="mb-4">
