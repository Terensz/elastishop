...
<div class="widgetWrapper lessObscure" style="position: relative; z-index: 3; padding: 10px;">
    ...
    <div class="widgetWrapper-info2" style="margin-left: 0; margin-right: auto;">
        Ha darazsak, méhek, lódarazsak szállták meg Önnél a padlást, az alsóépületet, a kerítést, vagy az egyik fát, forduljon hozzám bizalommal! <br>
        Bármilyen magasan is legyen a fészek, többé nem kell aggódnia.<br>
        A szolgáltatásra előzetes felmérés és megbeszélés alapján tudok árajánlatot adni.<br>
    </div>
