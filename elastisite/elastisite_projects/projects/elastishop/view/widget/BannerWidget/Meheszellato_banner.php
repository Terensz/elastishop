...
<div class="banner-bar">
    <div class="banner-container" style="background-color: #1e1e1e; height: 100%; ">
        <div style="background-color: #fcb31e; height: 100%; box-shadow: inset -25px 0 25px -25px rgba(0,0,0,0.8);">
            <div>
                <div class="banner-container-block banner-container-block-logo-padding" style="float: left; height: 100%;">
                    <img src="/image/bee.png" style="width: 44px;">
                </div>

                <div class="banner-container-block banner-container-block-padding banner-text-shadow-dark" style="float: left; background-color: #fcb31e; height: 100%; padding-right: 20px;">
                    <div>
                        Méhészellátó
                    </div>
                </div>
            ...
            <div style="font: 20px Kaushan-Regular; padding-left: 20px;">
                Békefi József, +36-70-55555557
            </div>
        </div>
        <!-- <div class="banner-container-block banner-container-block-padding banner-text-shadow-orange" style="float: left; background-color: #1e1e1e; color: #fcb31e; height: 100%;">
            ellátó
        </div> -->
