...
namespace framework\packages\WebshopPackage\service\payment\SimplePay\src;
...
class Base
{
    ...
    protected function prepare()
    {
        ...
        // $this->transactionBase['orderRef'] = 'ALMA00001';
    ...
    protected function execApiCall()
    {
        ...
        $commRresult = (string)$commRresult;
        // dump($this->config);
        dump($commRresult);//exit;
